...
<header class="w-[100vw] h-[12vh] bg-rose-700 py-4 px-8 flex justify-between items-center fixed left-0 top-0 z-10">
    ...
    <nav class="mr-6">
        <ul class="flex gap-6 text-lg">
            <li><a class="border-box pb-1 duration-300 border-b border-transparent hover:border-rose-300" href="index.php">Accueil</a></li>
            <li><a class="border-box pb-1 duration-300 border-b border-transparent hover:border-rose-300" href="creation.php">Création</a></li>
            <li><a class="border-box pb-1 duration-300 border-b border-transparent hover:border-rose-300" href="listPlayers.php">Liste des joueurs</a></li>
        </ul>
    </nav>
</header>